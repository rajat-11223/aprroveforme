class SystemStats
  ...
  def basic_stats(start_of_month)
    ...
    new_activated_user_approvals_count = count_of_new_activated_users_approvals(start_of_month: start_of_month)

    {
      ...
      new_users_approvals: new_activated_user_approvals_count,
      total_approvals: count_of(:created_ever, Approval, start_of_month: start_of_month),
      percent_new_approvals_by_new_users: find_percentage(new_activated_user_approvals_count, new_activated_users_count),
